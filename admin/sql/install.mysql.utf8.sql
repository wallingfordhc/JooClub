...
CREATE TABLE IF NOT EXISTS `#__cmperson` (
  ...
  `icename` VARCHAR(100) NULL,
  `icenumber` VARCHAR(45) NULL,
  `icerelationship` VARCHAR(100) NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `#__cmmatchstatus` ;
...
-- Table `#__cmscorer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `#__cmscorer` ;
...
-- Table `#__cmleague`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `#__cmleague` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `#__cmpersonphoto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `#__cmgroupconsent` ;
